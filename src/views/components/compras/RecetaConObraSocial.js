...
class RecetaConObraSocial extends Component {
  constructor(props) {
    super(props);
    this.state = {
      isLoading: false,
  ...
  handleSiguiente = async () => {
    ...
    //   gruposproductos: [
    //     {
    //       obra_social_frente: image_path_server + frente.img,
    //       obra_social_dorso: image_path_server + dorso.img,
  ...
  render() {
    const { farmaciaSelected, uFarmacia, frente, dorso, receta } = this.state;
            ...
            <div className="row my-5" align="left">
              <div className="col-sm-6">
                ...
                <div className="d-inline">
                  ...
                  <br />
                  <h4 className="d-inline ml-5">
                    <b>Carnet de la obra social</b>
                  </h4>
                  <small className="d-block ml-5">
                    Subí una foto (legible) de tu carnet de la obra social (máx
                    2MB)
                  </small>
                </div>
                ...
                <div className="d-inline ml-3">
                  <div className="container-fluid">
                    <div className="row ml-3">
                      <div className="col-sm-6 ">
                        Frente del carnet<span className="text-danger"> *</span>
                        <ImgUploader
                          value={frente ? frente.nombre : ""}
                          name="frente"
                          handleImg={this.handleImg}
                        />
                      </div>
                      <div className="col-sm-6 my-1">
                        Dorso del carnet<span className="text-danger">*</span>
                        <ImgUploader
                          value={dorso ? dorso.nombre : ""}
                          name="dorso"
                          handleImg={this.handleImg}
                        />
                      </div>
...
export default connect(mapStateToProps)(RecetaConObraSocial);
