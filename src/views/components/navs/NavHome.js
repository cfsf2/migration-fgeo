    ...
    render() {
        ...
        return (
            <>
                        ...
                        <div className="container-fluid">
                            <div className="row " align="center">
                                <div className="col-4 py-1"  >
                                    <a onClick={() => this.props.setmodalState(!this.props.modalState)}
                                        className="nav-farmageo-back" key={new Date} href={process.env.PUBLIC_URL + "/#/"}>
                    ...
                    >
                        <nav className="navbar navbar-expand-lg navbar-dark navbar-fixed-top m-0">
                            <div className="container-fluid">
                                <a
                                    className="nav-farmageo-back"
                                    onClick={() => this.props.setmodalState(!this.props.modalState)}
                                >
                        ...
                        Producto
                            ...
                            <div className="d-inline search-input">
                                <input
                                    ...
                                    onKeyPress={(e)=> e.which === 13 ? this.handleSearch() : null}
                ...
                <Login />
                <Registro />
                 <SeleccionarUbicacion setmodalState={this.props.setmodalState} modalState={this.props.modalState} />
            </>
        );
    }
}
